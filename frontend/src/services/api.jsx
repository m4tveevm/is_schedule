...
export const updateGroup = (id, data) =>
  axios.put(`${API_BASE_URL}groups/${id}/`, data);
...
export const createTeacher = (data) =>
  axios.post(`${API_BASE_URL}teachers/`, data);
export const updateTeacher = (id, data) =>
  axios.put(`${API_BASE_URL}teachers/${id}/`, data);
...
export const getTeacherUnavailableDates = (teacherId) => {
  return axios.get(
    `${API_BASE_URL}teacher_unavailable_dates/?teacher_id=${teacherId}`,
  );
};
...
export const createLecture = (data) =>
  axios.post(`${API_BASE_URL}lectures/`, data);
export const getLectures = (params) =>
  axios.get(`${API_BASE_URL}lectures/`, { params });
...
export const createSubject = (data) =>
  axios.post(`${API_BASE_URL}subjects/`, data);
export const updateSubject = (id, data) =>
  axios.put(`${API_BASE_URL}subjects/${id}/`, data);
export const deleteSubject = (id) =>
  axios.delete(`${API_BASE_URL}subjects/${id}/`);

// Учебные планы
export const getEducationalPlans = () =>
  axios.get(`${API_BASE_URL}educational_plans/`);
export const getEducationalPlanById = (id) =>
  axios.get(`${API_BASE_URL}educational_plans/${id}/`);
export const createEducationalPlan = (data) =>
  axios.post(`${API_BASE_URL}educational_plans/`, data);
export const updateEducationalPlan = (id, data) =>
  axios.put(`${API_BASE_URL}educational_plans/${id}/`, data);
export const deleteEducationalPlan = (id) =>
  axios.delete(`${API_BASE_URL}educational_plans/${id}/`);
export const searchEducationalPlans = (query) =>
  axios.get(
    `${API_BASE_URL}educational_plans/?search=${encodeURIComponent(query)}`,
  );

// Привязки учебных планов к группам
export const getGroupEducationalPlans = () =>
  axios.get(`${API_BASE_URL}group_educational_plans/`);
export const getGroupEducationalPlanById = (id) =>
  axios.get(`${API_BASE_URL}group_educational_plans/${id}/`);
export const createGroupEducationalPlan = (data) =>
  axios.post(`${API_BASE_URL}group_educational_plans/`, data);
export const updateGroupEducationalPlan = (id, data) =>
  axios.put(`${API_BASE_URL}group_educational_plans/${id}/`, data);
export const deleteGroupEducationalPlan = (id) =>
  axios.delete(`${API_BASE_URL}group_educational_plans/${id}/`);
export const searchGroupEducationalPlans = (query) =>
  axios
    .get(
      `${API_BASE_URL}group_educational_plans/?search=${encodeURIComponent(query)}`,
    )
    .then((res) => res.data);
...
// Назначения бригад
export const getBrigadeAssignments = () =>
  axios.get(`${API_BASE_URL}brigade_assignments/`);
...
export const getTeacherProfiles = () =>
  axios.get(`${API_BASE_URL}teacher_profiles/`);
export const createTeacherProfile = (data) =>
  axios.post(`${API_BASE_URL}teacher_profiles/`, data);
export const deleteTeacherProfile = (id) =>
  axios.delete(`${API_BASE_URL}teacher_profiles/${id}/`);
