...
function MainApp() {
  return (
    <Routes>
      ...
      <Route
        path="/educational_plans/:id/edit"
        element={<EducationalPlanForm />}
      />
      <Route
        path="/group_educational_plans"
        element={<GroupEducationalPlanList />}
      />
      <Route
        path="/group_educational_plans/add"
        element={<GroupEducationalPlanForm />}
      />
      <Route
        path="/group_educational_plans/:id/edit"
        element={<GroupEducationalPlanForm />}
      />
      <Route path="/brigade_assignments" element={<BrigadeAssignmentList />} />
      <Route
        path="/brigade_assignments/add"
        element={<BrigadeAssignmentForm />}
      />
      <Route
        path="/brigade_assignments/:id/edit"
        element={<BrigadeAssignmentForm />}
      />
      ...
      <Route
        ...
        element={<TeacherUnavailableDatesList />}
      />
      <Route
        path="/teacher_unavailable_dates/:id/edit"
        element={<TeacherUnavailableDatesForm />}
      />
      <Route
        path="/group_available_dates"
        element={<GroupAvailableDatesList />}
      />
      <Route
        path="/group_available_dates/:id/edit"
        element={<GroupAvailableDatesForm />}
      />
      ...
      <Route
        ...
        element={<TeacherSubjectAssignmentList />}
      />
      <Route
        path="/teacher_subject_assignments/add"
        element={<TeacherSubjectAssignmentForm />}
      />
