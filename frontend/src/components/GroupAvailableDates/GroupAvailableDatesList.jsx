...
function GroupAvailableDatesList() {
    ...
    const loadGroups = () => {
        setLoading(true);
        setError(null);
        axios.get(`${API_BASE_URL}groups/?search=${encodeURIComponent(searchTerm)}`)
    ...
    return (
        <div className="container">
            ...
            <p className="text-muted">Выберите группу и отредактируйте периоды,
                в которые она может проводить занятия.</p>
