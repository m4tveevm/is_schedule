...
function UserSettings() {
    ...
    const handleUpdateSettings = async () => {
        try {
            ...
            if (error.response) {
                ...
                setErrorMessage(
                    error.response.data.detail || 'Ошибка сервера. Проверьте данные и попробуйте снова.'
                );
                ...
                setErrorMessage('Произошла неожиданная ошибка. Попробуйте снова позже.');
            }
        }
    };
    ...
    return (
        <div className="container">
            ...
            {successMessage && <div
                className="alert alert-success mt-3">{successMessage}</div>}
            {errorMessage &&
