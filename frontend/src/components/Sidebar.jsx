          ...
          <>
            <li className="nav-item">
              <NavLink
                ...
                onClick={() => setShowMobileSidebar(false)}
              >
                <i className="fa-solid fa-user-tie"></i> Управление сотрудниками
              </NavLink>
            </li>
            <li className="nav-item">
              <NavLink
                ...
                onClick={() => setShowMobileSidebar(false)}
              >
                <i className="fa-solid fa-user-tie"></i> Управление Группами
              </NavLink>
            </li>
            <li className="nav-item">
              <NavLink
            ...
            <li className="nav-item">
              <NavLink
                ...
                onClick={() => setShowMobileSidebar(false)}
              >
                <i className="fa-solid fa-link"></i> Дисциплины преподавателя
              </NavLink>
            </li>
            <li className="nav-item">
              <NavLink
                ...
                onClick={() => setShowMobileSidebar(false)}
              >
                <i className="fa-solid fa-book"></i>Управление учебным планом
              </NavLink>
            </li>
            <li className="nav-item">
              <NavLink
                ...
                onClick={() => setShowMobileSidebar(false)}
              >
                <i className="fa-solid fa-link"></i> Привязка плана к группам
              </NavLink>
            </li>
            <li className="nav-item">
              <NavLink
                ...
                onClick={() => setShowMobileSidebar(false)}
              >
                <i className="fa-solid fa-briefcase"></i> Назначения бригад
              </NavLink>
            </li>
            <li className="nav-item">
              <NavLink
                ...
                onClick={() => setShowMobileSidebar(false)}
              >
                <i className="fa-solid fa-calendar-times"></i> Недоступные даты
                преподавателя
              </NavLink>
            </li>
            <li className="nav-item">
              <NavLink
                ...
                onClick={() => setShowMobileSidebar(false)}
              >
                <i className="fa-solid fa-calendar-check"></i> Даты практик
                группы
              </NavLink>
            </li>
            <li className="nav-item">
              <NavLink
                ...
                onClick={() => setShowMobileSidebar(false)}
              >
                <i className="fa-solid fa-calendar"></i> Календарь Группы
              </NavLink>
            </li>
          </>
        ) : (
