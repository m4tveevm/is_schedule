    ...
    return (
        <div className="container mt-4">
            ...
            <p className="text-muted">
                ...
                <br/>Пример структуры:
                <code> ФИО | Название предмета</code><br/>
            ...
            {!uploaded ? (
                <form onSubmit={handleSubmit} encType="multipart/form-data">
                    <div className="form-group mb-3">
                        ...
                        <input
                            ...
                            required
                        />
                        {file && <small className="text-muted">Выбран
                            файл: {file.name}</small>}
                    </div>
                    <div className="form-group mb-3">
                        ...
                        <select
                            ...
                            required
                        >
                            <option value="Основной">Основное место работы
                            </option>
                ...
                <div className="alert alert-success">
                    ...
                    <p>Преподаватели успешно импортированы.</p>
                    <button className="btn btn-success"
                            onClick={handleConfirm}>Ок
                    </button>
                </div>
            )}
        </div>
