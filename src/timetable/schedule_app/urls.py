...
urlpatterns = [
    ...
    path(
        "adjust_lectures/", views.adjust_lectures_view, name="adjust_lectures"
    ),
    path(
        "assign_teachers/", views.assign_teachers_view, name="assign_teachers"
    ),
